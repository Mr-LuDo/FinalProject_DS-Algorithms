...
#define CHECK_FOR_NULL_PTR(node, data)      ( (node) != nullptr ? (node->data) : (-1) )
...
class Node {
    public:
        Node(int key = -1) :
            ...
            key_(key), ripeRate_(0), tree_(nullptr),
        ...
        void PrintNode() {
            ...
            cout << "key_                   = " << key_ << endl;
            cout << "parent_tree_->key_ = " << CHECK_FOR_NULL_PTR(parent_tree_, key_);
            cout << "  at address: " << parent_tree_ << endl;
            cout << "left_tree_->key_   = " << CHECK_FOR_NULL_PTR(left_tree_, key_);
            cout << "  at address: " << left_tree_ << endl;
            cout << "right_tree_->key_  = " << CHECK_FOR_NULL_PTR(right_tree_, key_);
